                  ...
                  return (
                    <tr key={index}>
                      ...
                      <td className="py-2 border border-white text-center flex items-center justify-center gap-2">
                        <span className="cursor-pointer w-5" onClick={()=>editPassword(item.id)}>
                            <img  style={{
                                width: "25px",
                                height: "25px",
                                "paddingTop": "3px",
                                "paddingLeft": "3px",
                              }}src="icons/pen-solid.svg" alt=""/>
                        </span>
                        <span className="cursor-pointer w-5 mx-1" onClick={()=>deletePassword(item.id)}>
                            <img  style={{
                                width: "25px",
                                height: "25px",
                                "paddingTop": "3px",
                                "paddingLeft": "3px",
                              }}src="icons/trash-solid.svg" alt=""/>
                        </span>
                        </td>
                    </tr>
                  );
